namespace DMData.Code
{
    ...
    public static class StringHelper
    {
        ...
        public static string SubString(string pStr, int pLength)
        {
            return (pStr.Length > pLength ? pStr.Substring(0, pLength) : pStr);
        }

        public static string FullNumber(int number, int digital)
        {
            return (Math.Pow(10, digital) + number).ToString().Substring(1);
        }

        public static string XmlValue(string xml, string name)
        {
            int i = xml.IndexOf(name);
            int j; string r = ""; if (i != -1)
            {
                i = i + name.Length + 1;
                j = xml.IndexOf("<", i);
                if (j > i)
                    r = xml.Substring(i, j - i);
            }
            return r;
        }

        public static string RightString(string str)
        {
            int i = str.IndexOf(".");
            string r = "";
            if (i != -1)
        ...
        public static string ParamValue(string param, string name)
        {
            string s = param + ";";
            string f = s.ToLower();
            int i = f.IndexOf(name.ToLower());
            int j;
            string r = "";
            if (i != -1)
            {
